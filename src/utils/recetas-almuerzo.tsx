export const recetasAlmuerzo =  {
    ...
    102: {
        ...
        ingredients: [
            ...
            { name: 'Laurel', quantity: '1 hoja cada 10 porciones', unit: '' }
        ]
    },
    103: {
    ...
    114: {
        ...
        ingredients: [
            ...
            { name: 'Aceite', quantity: 10, unit: 'ml' },
            { name: 'Albahaca (se calcula 1 atado para 25 comensales)', quantity: 'C/N', unit: '' },
            { name: 'Sal', quantity: 0.5, unit: 'g' },
            { name: 'Ajo', quantity: 1, unit: 'g' },
            { name: 'Perejil', quantity: 1, unit: 'g' }
        ]
    ...
    118: {
        ...
        ingredients: [
            ...
            { name: 'Salsa Blanca Liviana', quantity: '1 porción', unit: '' },
            { name: 'Queso rallado', quantity: 5, unit: 'g' }
        ]
    },
    119: {
    ...
    120: {
        ...
        ingredients: [
            ...
            { name: 'Almidón de maíz', quantity: 2, unit: 'g' },
            { name: 'Sal', quantity: 0.5, unit: 'g' },
            { name: 'Hierbas o condimentos', quantity: 'C/N', unit: '' }
        ]
    },
    121: {
