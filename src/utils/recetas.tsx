export const recetas = {
    1: {
        ...
        ingredients: [
            ...
            { name: 'Polvo de hornear', quantity: 7, unit: 'g' },
            { name: 'Cocoa', quantity: 150, unit: 'g' },
    ...
    5: {
        ...
        variants: [
            ...
            { name: 'Coco', quantity: 50, unit: 'g' },
            { name: 'Cacao', quantity: 25, unit: 'g' }
        ]
    },
    6: {
        ...
        ingredients: [
            ...
            { name: 'Polvo de hornear', quantity: 10, unit: 'g' },
            { name: 'Canela', quantity: 5, unit: 'g' }
        ]
    },
    7: {
        title: 'Torta de naranja',
        ingredients: [
            { name: 'Naranja con cáscara', quantity: 150, unit: 'g' },
            { name: 'Harina', quantity: 160, unit: 'g' },
            { name: 'Polvo de hornear', quantity: 10, unit: 'g' },
    ...
    8: {
        ...
        variants: [
            ...
            { name: 'Hierbas aromáticas', quantity: 5, unit: 'g' },
            { name: 'Remolacha', quantity: 1, unit: 'unidad' },
            { name: 'Espinaca', quantity: 22, unit: 'g' },
            { name: 'Morrón', quantity: 45, unit: 'g' },
            { name: 'Salvado de trigo', quantity: 100, unit: 'g' }
        ]
    },
    9: {
    ...
    10: {
        ...
        variants:  [
            { name: 'Espinaca o rúcula fresca', quantity: 150, unit: 'g' },
            { name: 'Espinaca o rúcula congelada', quantity: 75, unit: 'g' },
            { name: 'Hierbas aromáticas secas', quantity: 2.5, unit: 'g' },
            { name: 'Hierbas aromáticas frescas', quantity: 10, unit: 'g' }
        ]
    },
    11: {
        title: 'Scones dulces',
    ...
    13: {
        ...
        variants:  [
            { name: 'Hierbas', quantity: 'c/n', unit: 'g' }
        ]
    },
    14: {
    ...
    15: {
        ...
        ingredients: [
            { name: 'Huevos', quantity: 2, unit: 'unid.' },
            { name: 'Harina', quantity: 160, unit: 'g' },
    ...
    16: {
        ...
        ingredients: [
            ...
            { name: 'Sal', quantity: 1.5, unit: 'g' }
        ]
    },
    17: {
        title: 'Galletitas cítricas',
        ingredients: [
            { name: 'Huevos', quantity: 1, unit: 'unid.' },
            { name: 'Harina', quantity: 240, unit: 'g' },
            { name: 'Azúcar', quantity: 100, unit: 'g' },
            { name: 'Aceite', quantity: 50, unit: 'g' },
            { name: 'Polvo de hornear', quantity: 10, unit: 'g' },
            { name: 'Jugo de naranja', quantity: 0.5, unit: 'unid.' },
    ...
    18: {
        ...
        ingredients: [
            ...
            { name: 'Aceite', quantity: 40, unit: 'g' },
    ...
    20: {
        ...
        ingredients: [
            ...
            { name: 'Polvo de hornear', quantity: 7, unit: 'g' },
            { name: 'Pasas de uva', quantity: 75, unit: 'g' },
            { name: 'Semillas de lino', quantity: 50, unit: 'g' },
            { name: 'Semillas de girasol', quantity: 50, unit: 'g' },
            { name: 'Maní sin sal', quantity: 50, unit: 'g' },
            { name: 'Manzana rallada', quantity: 150, unit: 'g' },
            { name: 'Ralladura de limón', quantity: 2, unit: 'g' }
        ]
    },
    21: {
        ...
        ingredients: [
            { name: 'Frutos secos deshidratados', quantity: 150, unit: 'g' },
            { name: 'Frutas deshidratadas', quantity: 150, unit: 'g' }
        ]
    },
    22: {
    ...
    24: {
        ...
        ingredients: [
            { name: 'Harina de mijo', quantity: 300, unit: 'g' },
