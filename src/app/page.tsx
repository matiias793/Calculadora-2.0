...
export default function Home() {
  return (
    <div className="mx-auto max-w-screen-xl px-4 w-full mt-10">
      ...
      <span className="font-bold text-3xl text-logoGreen text-center mt-5 w-full flex flex-col">Calculadora de Ingredientes</span>
      <span className="mb-8 text-center text-gray-800 w-full flex flex-col mt-3 text-lg">¿Qué vas a cocinar?</span>
