        ...
        import('jspdf-autotable').then((autoTable) => {
          ...
          if (exportFilterDepartamento) {
            uniformesToExport = uniformesToExport.filter(u =>
              u.departamento.toLowerCase() === exportFilterDepartamento.toLowerCase()
            );
          }
          if (exportFilterEscuela) {
            uniformesToExport = uniformesToExport.filter(u =>
          ...
          <div className="border-b border-gray-200 mb-6">
            <nav className="-mb-px flex space-x-4 sm:space-x-8">
              <button
                ...
                className={`py-2 px-1 border-b-2 font-medium text-xs sm:text-sm flex-1 sm:flex-none ${activeTab === 'users'
              ...
              <button
                ...
                className={`py-2 px-1 border-b-2 font-medium text-xs sm:text-sm flex-1 sm:flex-none ${activeTab === 'uniformes'
                    ? 'border-green-500 text-green-600'
                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`py-2 px-1 border-b-2 font-medium text-xs sm:text-sm flex-1 sm:flex-none ${activeTab === 'recetas'
                    ? 'border-green-500 text-green-600'
                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }`}
              >
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredUsers.map((user) => (
                        <tr key={user.documento} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${user.tarea === 'cocina' ? 'bg-orange-100 text-orange-800' :
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredUniformes.map((uniforme) => (
                        <tr key={uniforme.documento} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${uniforme.tipo_uniforme === 'cocina' ? 'bg-orange-100 text-orange-800' :
